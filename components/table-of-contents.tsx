...
export function TableOfContents({ headings, isMobile = false }: TableOfContentsProps) {
  ...
  return (
    <div id="desktop-toc" className="hidden lg:block fixed left-0 top-24 w-64 max-h-[calc(100vh-6rem)] overflow-y-auto pl-6">
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-5 shadow-sm sticky top-0">
