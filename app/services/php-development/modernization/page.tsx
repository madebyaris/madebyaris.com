...
const structuredData = {
  ...
  "description": "Professional PHP modernization services to upgrade legacy applications with current best practices, improved security, and enhanced performance.",
  "provider": {
    "@type": "Person",
    "name": "Aris Setiawan",
  ...
  "offers": {
    "@type": "Offer",
    "description": "PHP application modernization and upgrade services"
  },
  "keywords": [
    "PHP modernization",
    "legacy code upgrade",
