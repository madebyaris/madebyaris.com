...
const structuredData = {
  ...
  "description": "Professional PHP API development services. Build secure, scalable, and well-documented APIs using modern PHP frameworks and best practices.",
  "provider": {
    "@type": "Person",
    "name": "Aris Setiawan",
  ...
  "offers": {
    "@type": "Offer",
    "description": "PHP API development and integration services"
  },
  "keywords": [
    "PHP API development",
    "REST API",
